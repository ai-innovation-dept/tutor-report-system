...
@pytest.fixture()
def users(db):
    tutor = User(email="step4-tutor@example.com", role="tutor", roles=["tutor"], display_name="講師A", password_hash=hash_password("Passw0rd!"))
    other_tutor = User(email="step4-other@example.com", role="tutor", roles=["tutor"], display_name="講師B", password_hash=hash_password("Passw0rd!"))
    school = User(email="step4-school@example.com", role="school", roles=["school"], display_name="学校", password_hash=hash_password("Passw0rd!"))
    sales = User(email="step4-sales@example.com", role="sales", roles=["sales"], display_name="営業", password_hash=hash_password("Passw0rd!"))
