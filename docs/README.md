...
- [`INFRASTRUCTURE.md`](INFRASTRUCTURE.md) — 本番インフラ・デプロイ・クリーン投入手順（**接続情報・現況の正**）
- [`HANDOFF.md`](HANDOFF.md) — 引継ぎ・未対応事項・本番反映状況

### AWS EC2 インフラ（Lightsail → EC2 移行・2026-07）
- [`EC2/インフラ仕様書.md`](EC2/インフラ仕様書.md) — EC2環境のインフラ仕様（構成・ポート/SG・セキュリティ・環境変数・制約）
- [`EC2/デプロイ手順書.md`](EC2/デプロイ手順書.md) — 通常デプロイ・マイグレーション・メール切替・バックアップ・ロールバック・切替手順
- [`EC2/Lightsailとの差分.md`](EC2/Lightsailとの差分.md) — 開発者向け：Lightsail時代との差分（変わる点／変わらない点・二重稼働注意）
- [`EC2移行_引継ぎ_202607241011.md`](EC2移行_引継ぎ_202607241011.md) — 移行の全体像・ランブック（着手時の引継ぎ資料）
