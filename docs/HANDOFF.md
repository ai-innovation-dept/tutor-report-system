...
最終更新: 2026-07-23（代々木進学会 改修 202607231908＝保護者アンケートの送信を「承認と同時のみ」へ変更（専用送信ボタン廃止）。同日 202607231903＝提出締切を「翌月1日固定」へ変更・202607231755＝①志望校引継ぎ・②メニュー「指導報告・日報」・③保護者アンケート・④月報必須の緩和）
