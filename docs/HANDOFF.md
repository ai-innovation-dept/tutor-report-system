...
最終更新: 2026-07-23（代々木進学会 改修 202607231903＝提出締切を「翌月第一営業日」→「翌月1日固定（土日祝でも繰り延べない）」へ変更・jpholiday/BUSINESS_CLOSED_DAYS 廃止。同日 202607231755＝①志望校引継ぎ・②メニュー「指導報告・日報」・③保護者アンケート・④月報必須の緩和）
